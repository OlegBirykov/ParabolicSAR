...
risk = 2;                                       -- размер остатка позиции после быстрого профита, остающийся до следующего сигнала по SAR
...
quickStop = 20;                                 -- смещение для быстрого стопа в валюте цены (полное закрытие позиции)
