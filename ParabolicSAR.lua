...
stop = 20;                                      -- размер стоп-лимита в шагах цены

-- параметры ручных стоп-сигналов, дополняющих сигналы от SAR
referenceLevel = 0;                             -- опорный уровень (уровень подтверждения сигнала SAR)
...
triggerOffset = 50;                             -- смещение относительно последнего значения SAR до разрыва графика,
