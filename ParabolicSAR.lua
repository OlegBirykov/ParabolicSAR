...
emit = 'SiZ3';                                  -- код инструмента (фьючерс US-RU до декабря 2023)
...
spread = 30;                                    -- защитный спред при выставлении лимитной заявки в шагах цены
stop = 200;                                     -- размер стоп-лимита в шагах цены
